...
const posts = [
  {
    ...
    date: '2024-11-10',
    excerpt:
      "The 8:23 AM Tsuen Wan Line doesnt have to stress you out. Here are five discreet, powerful breathwork techniques you can practice with your eyes closed and your hand on the rail.",
  ...
  },
  {
    ...
    date: '2024-11-20',
    excerpt:
      "Theres no such thing as total silence in Hong Kong, but these five urban oases come close. Our teacher Suki Li shares her secret spots for a quiet sunrise practice.",
  ...
  },
  {
    ...
    date: '2024-12-01',
    excerpt:
      "Jason Tsang, our corporate mindfulness lead, explains why a single workshop isnt enough, and what a real wellness strategy looks like for Hong Kong teams.",
    body: "The burnout statistics in HK finance and law, the difference between a perk and a practice, how to design a 6-week mindfulness program, the ROI of reduced turnover, and a real case study of a team that saw a 30% drop in sick leave after implementing Jasons methods.",
    author: 'Jason Tsang',
  },
];
